...
a persistence unit "RemedialAtancuriJonathanPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "RemedialAtancuriJonathan\pom.xml":
...
artifact ("RemedialAtancuriJonathan.war") is already built. You can build
